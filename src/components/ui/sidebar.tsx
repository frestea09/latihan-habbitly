      ...
      >
        ...
        <div
          className={cn(
            ...
            variant === "floating" || variant === "inset"
              ? "w-[calc(var(--sidebar-width)_+_theme(spacing.4)_+2px)] p-2 group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)_+_theme(spacing.4)_+2px)]"
...
const SidebarMenuButton = React.forwardRef<
  ...
  Omit<React.ButtonHTMLAttributes<HTMLButtonElement>, 'onToggle'> &
    Omit<React.AnchorHTMLAttributes<HTMLAnchorElement>, 'onToggle'> & {
      href?: string
      asChild?: boolean
      isActive?: boolean
